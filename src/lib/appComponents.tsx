...
export const appComponents: AppComponentMap = {
  ...
  editor:           lazy(() => import('../apps/cakra/tabs/Editor')),
  ...
  'prompt-generator':   lazy(() => import('../apps/cakra/tabs/PromptGenerator')),
  'token-counter':      lazy(() => import('../apps/cakra/tabs/TokenCounter')),
