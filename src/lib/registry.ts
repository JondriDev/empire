...
export const apps: AppDefinition[] = [
  ...
  { id: 'editor', name: 'Code Editor', icon: 'Code2', route: '/app/editor', description: 'Write & edit code', color: '#5b8fb9', cakraEnabled: true },
  ...
  { id: 'prompt-generator', name: 'Prompt Gen', icon: 'Wand2', route: '/app/prompt-generator', description: 'Craft AI prompts', color: '#5b8fb9', cakraEnabled: true },
  { id: 'token-counter', name: 'Token Counter', icon: 'Hash', route: '/app/token-counter', description: 'Count AI tokens', color: '#8fb4d8', cakraEnabled: true },
